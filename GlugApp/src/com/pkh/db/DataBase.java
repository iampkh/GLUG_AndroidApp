...
public class DataBase {
	...
	public DataBase(Context context,ArrayList<String> tablelist) {
		// TODO Auto-generated constructor stub
		helpDB=new HelperDB(context,tablelist);
		tableLIst=tablelist;
		openDB();
		// closeDB();
...
/*	 public Cursor getLastRow(String TABLE_NAME){
	...
	class HelperDB extends SQLiteOpenHelper{
		...
		public void onCreate(SQLiteDatabase db) {
			...
			//String CREATE_CONTACTS_TABLE = "CREATE TABLE IF NOT EXISTS glugpuduvai("+KEY_ID+" TEXT,"+KEY_TITLE+" TEXT,"+KEY_LINK+" TEXT,"+KEY_DESC+" TEXT"+")";
			//db.execSQL(CREATE_CONTACTS_TABLE);
			for(int index=0;index<list.size();index++){
				Log.d("pkhtag", "pkh create table feed ======"+index);
				String CREATE_CONTACTS_TABLE = "CREATE TABLE IF NOT EXISTS "+list.get(index)+"("+KEY_ID+" TEXT,"+KEY_TITLE+" TEXT,"+KEY_LINK+" TEXT,"+KEY_DESC+" TEXT"+")";
				db.execSQL(CREATE_CONTACTS_TABLE);
				
			}
			
			String CREATE_CONTACTS_TABLE = "CREATE TABLE IF NOT EXISTS "+RECENT_TABLE_NAME+"("+KEY_ID+" TEXT,"+KEY_TITLE+" TEXT,"+KEY_LINK+" TEXT,"+KEY_DESC+" TEXT"+")";
			db.execSQL(CREATE_CONTACTS_TABLE);
